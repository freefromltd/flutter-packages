...
@property(nonatomic, weak) FGMGoogleMapController *controller;
...
@property(nonatomic, strong) FGMPolylinesController *polylinesController;
@property(nonatomic, strong) FGMCirclesController *circlesController;

// The controller that handles heatmaps
@property(nonatomic, strong) FGMHeatmapsController *heatmapsController;
@property(nonatomic, strong) FGMTileOverlaysController *tileOverlaysController;
...
- (instancetype)initWithMapView:(GMSMapView *_Nonnull)mapView
  ...
  if (self = [super init]) {
    ...
    _polylinesController = [[FGMPolylinesController alloc] initWithMapView:_mapView
                                                             eventDelegate:_mapEventHandler];
    _circlesController = [[FGMCirclesController alloc] initWithMapView:_mapView
                                                         eventDelegate:_mapEventHandler];
    _heatmapsController = [[FGMHeatmapsController alloc] initWithMapView:_mapView];
    _tileOverlaysController = [[FGMTileOverlaysController alloc] initWithMapView:_mapView
                                                                    tileProvider:self];
    _groundOverlaysController =
        [[FGMGroundOverlaysController alloc] initWithMapView:_mapView
                                               eventDelegate:_mapEventHandler
                                               assetProvider:assetProvider];
